...
public class WorldGen {
    ...
    public static enum Ore {
        ...
        CRYSTAL(20, 0, 128, null, 10, 1, NON_GEN_LEVELS),
        AMETHYST(8, 0, 16, null, 2, 1, NON_GEN_LEVELS),
        COPPER(8, 0, 64, null, 15, 1, NON_GEN_LEVELS),
        PYRITE(8, 0, 32, null, 5, 1, NON_GEN_LEVELS),
        MAGNEZE(8, 0, 32, null, 3, 1, NON_GEN_LEVELS),
        SILVER(8, 0, 32, null, 3, 1, NON_GEN_LEVELS),
        MAGILITH(8, 0, 32, null, 3, 1, NON_GEN_LEVELS),
        DRAGON(50, 0, 16, null, 1, 0.05, NON_GEN_LEVELS),
        PLATINUM(8, 0, 16, null, 3, 1, NON_GEN_LEVELS),
        PALADINIUM(8, 0, 16, null, 3, 1, NON_GEN_LEVELS),
        FIRIUM(8, 0, 16, null, 3, 0.2, NON_GEN_LEVELS),
        GLACIUM(8, 0, 16, ICY_BIOMES, 3, 0.2, NON_GEN_LEVELS),
        FOUDIUM(8, 0, 16, null, 3, 0.2, NON_GEN_LEVELS),
        SLATE(50, 64, 128, null, 20, 0.3, NON_GEN_LEVELS),
        SALT(50, 32, 64, null, 20, 0.45, NON_GEN_LEVELS),
        MARBLE(100, 16, 64, null, 20, 0.2, NON_GEN_LEVELS),
        MAGNETITE(20, 0, 64, null, 20, 0.5, NON_GEN_LEVELS),
        CHALK(50, 32, 64, null, 20, 0.3, NON_GEN_LEVELS);
